...
urlpatterns = [
    ...
    path('studant/search/user/', views.search, {'type': 'usuarios'}, name='search_usuarios'),
    path('studant/search/loan/', views.search, {'type': 'emprestimos'}, name='search_emprestimos'),
