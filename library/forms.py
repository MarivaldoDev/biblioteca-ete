...
class UserForm(forms.ModelForm):
    class Meta:
        model = UserStandard
        fields = ("nome", "matricula", "curso", "email", "turma", "imagem")

        widgets = {
            "nome": forms.TextInput(attrs={"placeholder": "Seu nome", "id": "input"}),
            "matricula": forms.TextInput(
                attrs={"placeholder": "Sua matricula", "id": "input2"}
            ),
            "curso": forms.TextInput(
                attrs={"placeholder": "Seu curso", "id": "input3"}
            ),
            "email": forms.TextInput(
                attrs={"placeholder": "Seu E-mail", "id": "input4"}
            ),
